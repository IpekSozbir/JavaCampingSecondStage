...
public class C12_DikkatEdilecekKonu {
    ...
    public static void main(String[] args) {
        ...
        eger kullanicidan aldigimiz degeri birden fazla islemde kullanacaksak
        degerini baska bir variable'a atayip degisiklikleri diger variable'da yapmaliyiz
         */

        // Kullanicidan pozitif bir tamsayi alip rakamlar toplamini yazdirin.
        // Ilk islem bittikten sonra 1'den verilen sayiya kadar 17 ile bolunebilen sayilari yazdirin
        ...
        System.out.println("Girmis oldugunuz sayi: " + sayi); //45861
